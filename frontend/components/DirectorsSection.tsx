    ...
    <div id="directors" className="flex flex-col gap-4">
      <div className="flex items-start gap-2">
        <div className="flex-1 min-w-0">
          <h2 className="text-xl font-bold text-white leading-snug">🎬 Directors Worked With</h2>
          <p className="text-sm text-white/35 mt-0.5">Most collaborated directors</p>
        </div>
        {actorName && (
          ...
          return (
            <button
              ...
              className={`
                ...
                ${active
                  ? 'border-violet-500/60 text-white/90 bg-violet-500/15 scale-[1.02]'
                  : 'border-white/[0.08] text-white/55 hover:text-white/85 hover:border-white/22 hover:scale-[1.02]'
                }
              `}
